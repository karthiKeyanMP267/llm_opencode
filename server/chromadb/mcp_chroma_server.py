...
Simplified for persistent client usage with your local chroma_data folder.
  ...
  "mcpServers": {
    "chroma": {
      ...
      "args": [
        ...
        "--data-dir", "C:/Users/vikym/Documents/GitHub/llmAgent/chromaDB_MCP/chroma_data"
      ]
    }
  }
}
...
def create_parser():
    ...
    parser.add_argument('--data-dir',
                       default=os.getenv('CHROMA_DATA_DIR', './chroma_data'),
